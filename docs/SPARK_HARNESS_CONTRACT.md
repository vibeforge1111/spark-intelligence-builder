...
- `src/spark_intelligence/harness_runtime/service.py` gates `builder.direct`, `browser.navigate`, and `researcher.advisory` before execution and records canonical result ledgers; other runners need explicit ledger evidence before they are claimed covered.
