...
- first Discord webhook skeleton on `/webhooks/discord` with route validation, Discord signature verification via interaction public key, compatibility fallback secret auth for the stub path, and JSON parsing before Discord normalization
