...
| Builder bridge | Plain chat, provider fallback, final-answer gate, unsupported edit/completion claims, memory-route boundary, direct voice/media delivery | E2E tests show unsupported edit and unproved completion claims are suppressed with trace ids; direct Builder voice/media delivery now inherits the same claim gate. Live coverage incomplete in this slice. | 7 | Yellow | Test natural chat and Builder fallback via Telegram; verify no edit/done claims without owner proof. |
