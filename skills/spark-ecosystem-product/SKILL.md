...
1. Does this deepen the wedge or widen the surface?
2. Should this live in Spark Intelligence, Spark Researcher, Spark Swarm, a domain chip, or a specialization path?
3. Does this make the agent feel more coherent or more fragmented?
4. Does this improve retention or only improve the demo?
5. Is this modular in the right way, or just split apart cosmetically?

## Workflow

1. Define the user-facing behavior.
2. Assign the correct subsystem owner.
