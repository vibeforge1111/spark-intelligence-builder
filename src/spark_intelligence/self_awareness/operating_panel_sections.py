...
def build_agent_panel_sections(
    *,
    ...
    if not isinstance(aoc_payload, str): aoc_payload = str(aoc_payload or '')
    if not isinstance(scratchpad_payload, str): scratchpad_payload = str(scratchpad_payload or '')
    if not isinstance(black_box_payload, str): black_box_payload = str(black_box_payload or '')
    if not isinstance(source_ledger_payload, str): source_ledger_payload = str(source_ledger_payload or '')
    if not isinstance(stale_sweep_payload, str): stale_sweep_payload = str(stale_sweep_payload or '')
