        ...
        TelegramMemoryBenchmarkPack(
            ...
            cases=(
                *_existing(
                    ...
                    "favorite_color_write",
                    "favorite_color_query",
                    "favorite_color_delete",
                    "favorite_color_query_after_delete",
                    "favorite_food_write",
                    "favorite_food_query",
                    "favorite_food_delete",
                    "generic_plan_write",
                    "generic_plan_overwrite",
                    "generic_plan_current_query_after_overwrite",
                    "generic_plan_history_query_after_overwrite",
                    "generic_plan_delete",
                    "generic_plan_current_query_after_delete",
                    ...
                    "generic_owner_write",
                    "generic_owner_overwrite",
                    "generic_owner_current_query_after_overwrite",
                    "generic_owner_history_query_after_overwrite",
                    "generic_owner_delete",
                    "generic_owner_current_query_after_delete",
                    "generic_owner_history_query_after_delete",
                    "generic_owner_event_history_query_after_delete",
                ),
            ),
        ),
        TelegramMemoryBenchmarkPack(
