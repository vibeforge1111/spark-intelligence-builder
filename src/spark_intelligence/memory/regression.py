...
DEFAULT_TELEGRAM_MEMORY_REGRESSION_CASES: tuple[TelegramMemoryRegressionCase, ...] = (
    ...
    TelegramMemoryRegressionCase(
        case_id="favorite_color_write",
        category="preference_memory",
        message="My favorite color is cobalt blue.",
        expected_bridge_mode="memory_generic_observation_update",
        expected_routing_decision="memory_generic_observation",
        expected_response_contains=("favorite color", "cobalt blue"),
        benchmark_tags=("telegram_runtime_preference", "durable_profile"),
    ),
    TelegramMemoryRegressionCase(
        case_id="favorite_color_query",
        category="preference_memory",
    ...
    TelegramMemoryRegressionCase(
        case_id="favorite_color_delete",
        category="preference_memory_delete",
        message="Forget my favorite color.",
        expected_bridge_mode="memory_generic_observation_delete",
        expected_routing_decision="memory_generic_observation_delete",
        expected_response_contains=("forget", "favorite color"),
        benchmark_tags=("telegram_runtime_preference", "delete"),
    ),
    TelegramMemoryRegressionCase(
        case_id="favorite_color_query_after_delete",
        category="preference_memory_delete",
        message="What is my favorite color?",
        expected_bridge_mode="memory_profile_fact",
        expected_routing_decision="memory_profile_fact_query",
        expected_response_contains=("don't currently have",),
        benchmark_tags=("telegram_runtime_preference", "delete", "abstention"),
    ),
    TelegramMemoryRegressionCase(
        case_id="favorite_food_write",
        category="preference_memory",
        message="The food I love the most is shakshuka.",
        expected_bridge_mode="memory_generic_observation_update",
        expected_routing_decision="memory_generic_observation",
        expected_response_contains=("favorite food", "shakshuka"),
        benchmark_tags=("telegram_runtime_preference", "durable_profile"),
    ),
    TelegramMemoryRegressionCase(
        case_id="favorite_food_query",
        category="preference_memory",
    ...
    TelegramMemoryRegressionCase(
        case_id="favorite_food_delete",
        category="preference_memory_delete",
        message="Forget my favorite food.",
        expected_bridge_mode="memory_generic_observation_delete",
        expected_routing_decision="memory_generic_observation_delete",
        expected_response_contains=("forget", "favorite food"),
        benchmark_tags=("telegram_runtime_preference", "delete"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_write",
        category="generic_memory",
        message="We plan to complete live memory deletion checks.",
        expected_bridge_mode="memory_generic_observation_update",
        expected_routing_decision="memory_generic_observation",
        expected_response_contains=("current plan", "complete live memory deletion checks"),
        benchmark_tags=("telegram_runtime_plan", "active_state"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_overwrite",
        category="generic_memory",
        message="Actually, the current plan is to complete live memory preference checks.",
        expected_bridge_mode="memory_generic_observation_update",
        expected_routing_decision="memory_generic_observation",
        expected_response_contains=("current plan", "complete live memory preference checks"),
        benchmark_tags=("telegram_runtime_plan", "active_state", "overwrite"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_current_query_after_overwrite",
        category="generic_memory",
        message="What is my current plan?",
        expected_bridge_mode="memory_profile_fact",
        expected_routing_decision="memory_profile_fact_query",
        expected_response_contains=("complete live memory preference checks",),
        expected_response_excludes=("complete live memory deletion checks",),
        benchmark_tags=("telegram_runtime_plan", "current_state", "overwrite"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_history_query_after_overwrite",
        category="generic_memory_history",
        message="What was my previous plan?",
        expected_bridge_mode="memory_profile_fact_history",
        expected_routing_decision="memory_profile_fact_history_query",
        expected_response_contains=("complete live memory deletion checks", "complete live memory preference checks"),
        benchmark_tags=("telegram_runtime_plan", "native_history", "overwrite"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_delete",
        category="generic_memory_delete",
        message="Forget my current plan.",
        expected_bridge_mode="memory_generic_observation_delete",
        expected_routing_decision="memory_generic_observation_delete",
        expected_response_contains=("forget", "current plan"),
        benchmark_tags=("telegram_runtime_plan", "delete"),
    ),
    TelegramMemoryRegressionCase(
        case_id="generic_plan_current_query_after_delete",
        category="generic_memory_delete",
        message="What is my current plan?",
        expected_bridge_mode="memory_profile_fact",
        expected_routing_decision="memory_profile_fact_query",
        expected_response_contains=("don't currently have",),
        benchmark_tags=("telegram_runtime_plan", "delete", "abstention"),
    ),
    TelegramMemoryRegressionCase(
