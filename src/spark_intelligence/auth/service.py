    ...
    with state_db.connect() as conn:
        conn.execute(
            ...
            (
                ...
                str(token_payload.get("access_token")),  # TODO: encrypt before storage; column name "ciphertext" implies encryption
                str(token_payload.get("refresh_token")) if token_payload.get("refresh_token") else None,  # TODO: same
                access_expires_at,
                refresh_expires_at,
            ),
        )
