...
def build_parser() -> argparse.ArgumentParser:
    ...
    _auth_mode_group = auth_login_parser.add_mutually_exclusive_group()
    _auth_mode_group.add_argument("--callback-url", help="Full callback URL captured after OAuth approval")
    _auth_mode_group.add_argument("--listen", action="store_true", help="Wait for the loopback OAuth callback and complete login automatically")
