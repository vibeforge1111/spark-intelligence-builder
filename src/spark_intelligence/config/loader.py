...
SPARK_INTELLIGENCE_BUILDER__WINDOWS_ENV_PERMISSION_STATUS_TIMEOUT_SECONDS = 60
...
class ConfigManager:
    ...
    def _windows_env_permission_status(self) -> tuple[bool, str]:
        ...
        timeout=SPARK_INTELLIGENCE_BUILDER__WINDOWS_ENV_PERMISSION_STATUS_TIMEOUT_SECONDS,
        )
