...
- Phase 2.1 (PR pending): new starter chips get one explicitly authored draft-or-clarify development case. Generic starters retain 14 cases; realistic packs retain every original case plus the new case, with matching manifests. Scores before and after this change are not comparable as one trend.
