...
class CapabilityRouterTests(SparkTestCase):
    def test_browser_task_routes_to_researcher_when_legacy_browser_is_attached(self) -> None:
        ...
        self.assertIn("legacy browser extension is disabled", decision.reason)
    ...
    def test_capability_router_prompt_context_describes_route(self) -> None:
        ...
        self.assertIn("legacy browser extension is disabled", prompt_context)
