...
class CliSmokeTests(SparkTestCase):
    ...
    def test_memory_feedback_is_traceable_without_counting_as_memory_movement(self) -> None:
        ...
        self.assertEqual(run_payload["summary"]["automated_correction_score"], 1.0)
        self.assertEqual(run_payload["summary"]["automated_failure_rate"], 0.0)
        self.assertEqual(run_payload["summary"]["operator_judgment_rate"], 1.0)
